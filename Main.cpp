...
int main(){
  ...
  t.layers.push_back(std::make_unique<Conv2DLayer>(1,16,3,3));
  t.layers.push_back(std::make_unique<Conv2DLayer>(16,32,2,3));
  t.layers.push_back(std::make_unique<Pool2DLayer>(2,2));
  t.layers.push_back(std::make_unique<Conv2DLayer>(32,32,3,2));
  t.layers.push_back(std::make_unique<Conv2DLayer>(32,32,3,3));
  t.layers.push_back(std::make_unique<GlobalAvePool2DLayer>());
  t.layers.push_back(std::make_unique<DenseLayer>(32,32));
  t.layers.push_back(std::make_unique<DenseLayer>(32,10));

  const int MNIST_size = 10000;
